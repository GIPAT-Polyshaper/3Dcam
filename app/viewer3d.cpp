...
public:
    ...
    void synchronize(QQuickFramebufferObject *item)
    {
        ...
        if (triangles_dirty || volume_dirty)
        {
            ...
            obj.setCamera(GCodeGenerator::get_instance().getAzimuth(),
                          GCodeGenerator::get_instance().getDistance(),
                          GCodeGenerator::get_instance().getElevation());

            obj.setVolume(GCodeGenerator::get_instance().getVolumeX(),
                          GCodeGenerator::get_instance().getVolumeY(),
                          GCodeGenerator::get_instance().getVolumeZ());
